...
public class SpaceTest {
    ...
    Space s2 = new Space("green", 1,  false);
    Space s3 = new Space("green", 1,  false);
    Space s4 = new Space("green", 1,  false);
    Space s5 = new Space("green", 1,  false);
    Space s6 = new Space("green", 1,  false);
    Space s7 = new Space("green", 1,  false);
