...
public class Serpentine extends Map {
    ...
    private void setup(){
        ...
        tile2	.addRow1(	new Space(	"green"	,	75	,	1	,	false,	false));
        tile2	.addRow1(	new Space(	"green"	,	76	,	1	,	false,	false));
        tile2	.addRow1(	new Space(	"grey"	,	77	,	1	,	false,	false));
        tile2	.addRow1(	new Space(	"grey"	,	78	,	1	,	false,	false));
        ...
        tile3	.addRow4(	new Space(	"green"	,	164	,	1	,	false,	false));
        ...
        tile3	.addRow5(	new Space(	"green"	,	171	,	1	,	false,	false));
        ...
        tile3	.addRow6(	new Space(	"grey"	,	177	,	1	,	false,	false));
        ...
        tile3	.addRow7(	new Space(	"grey"	,	183	,	1	,	false,	false));
        tile3	.addRow7(	new Space(	"grey"	,	184	,	1	,	false,	false));
        tile3	.addRow7(	new Space(	"green"	,	185	,	1	,	false,	false));
        ...
        tile5	.addRow1(	new Space(	"blue"	,	334	,	1	,	false,	false));
        tile5	.addRow1(	new Space(	"blue"	,	335	,	1	,	false,	false));
        tile5	.addRow1(	new Space(	"blue"	,	336	,	1	,	false,	false));
        tile5	.addRow1(	new Space(	"blue"	,	337	,	1	,	false,	false));
        ...
        tile5	.addRow4(	new Space(	"yellow"	,	349	,	1	,	false,	false));
        ...
        tile6	.addRow1(	new Space(	"green"	,	445	,	1	,	false,	false));
        tile6	.addRow1(	new Space(	"green"	,	446	,	1	,	false,	false));
        tile6	.addRow1(	new Space(	"green"	,	447	,	1	,	false,	false));
        tile6	.addRow1(	new Space(	"red"	,	448	,	1	,	false,	false));
