...
public class HillsOfGoldMap extends Map {
    ...
    private void setup(){
        ...
        tile2	.addRow7(	new Space(	"yellow"	,	108	,	1	,	true));
        tile2	.addRow7(	new Space(	"yellow"	,	109	,	1	,	true));
        tile2	.addRow7(	new Space(	"blue"	,	110	,	1	,	true));
        tile2	.addRow7(	new Space(	"blue"	,	111	,	1	,	true));
        ...
        tile3	.addRow2(	new Space(	"green"	,	227	,	1	,	true));
        ...
        tile3	.addRow3(	new Space(	"yellow"	,	232	,	1	,	true));
        ...
        tile3	.addRow4(	new Space(	"black"	,	238	,	0	,	true));
        ...
        tile4	.addRow4(	new Space(	"green"	,	386	,	2	,	true));
        ...
        tile4	.addRow5(	new Space(	"green"	,	393	,	2	,	true));
        ...
        tile4	.addRow6(	new Space(	"green"	,	399	,	2	,	true));
        ...
        tile4	.addRow7(	new Space(	"green"	,	404	,	1	,	true));
        ...
        tile5	.addRow4(	new Space(	"yellow"	,	349	,	1	,	true));
        ...
        tile5	.addRow5(	new Space(	"yellow"	,	356	,	1	,	true));
        ...
        tile5	.addRow6(	new Space(	"yellow"	,	362	,	1	,	true));
        ...
        tile5	.addRow7(	new Space(	"yellow"	,	367	,	1	,	true));
        ...
        tile6	.addRow2(	new Space(	"green"	,	489	,	1	,	false));
        tile6	.addRow2(	new Space(	"blue"	,	490	,	1	,	false));
        tile6	.addRow3(	new Space(	"yellow"	,	491	,	1	,	false));
        tile6	.addRow3(	new Space(	"yellow"	,	492	,	2	,	false));
        tile6	.addRow3(	new Space(	"green"	,	493	,	1	,	false));
        tile6	.addRow3(	new Space(	"blue"	,	494	,	1	,	false));
        tile6	.addRow3(	new Space(	"blue"	,	495	,	1	,	false));
        tile6	.addRow3(	new Space(	"blue"	,	496	,	1	,	false));
        tile6	.addRow4(	new Space(	"blue"	,	497	,	1	,	false));
        tile6	.addRow4(	new Space(	"blue"	,	498	,	1	,	false));
        tile6	.addRow4(	new Space(	"yellow"	,	499	,	3	,	false));
        tile6	.addRow4(	new Space(	"yellow"	,	500	,	4	,	false));
        tile6	.addRow4(	new Space(	"yellow"	,	501	,	3	,	false));
        tile6	.addRow4(	new Space(	"yellow"	,	502	,	2	,	false));
        tile6	.addRow4(	new Space(	"yellow"	,	503	,	1	,	false));
        tile6	.addRow5(	new Space(	"blue"	,	504	,	1	,	false));
        tile6	.addRow5(	new Space(	"blue"	,	505	,	1	,	false));
        tile6	.addRow5(	new Space(	"blue"	,	506	,	1	,	false));
        tile6	.addRow5(	new Space(	"green"	,	507	,	1	,	false));
        tile6	.addRow5(	new Space(	"yellow"	,	508	,	2	,	false));
        tile6	.addRow5(	new Space(	"yellow"	,	509	,	1	,	false));
        tile6	.addRow6(	new Space(	"green"	,	510	,	1	,	false));
        tile6	.addRow6(	new Space(	"green"	,	511	,	1	,	false));
        tile6	.addRow6(	new Space(	"green"	,	512	,	2	,	false));
        tile6	.addRow6(	new Space(	"green"	,	513	,	1	,	false));
        tile6	.addRow6(	new Space(	"green"	,	514	,	1	,	false));
        tile6	.addRow7(	new Space(	"green"	,	515	,	1	,	false));
