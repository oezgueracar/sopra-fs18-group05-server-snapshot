...
public class HomeStretch extends Map {
    ...
    private void setup(){
        ...
        tile2	.addRow1(	new Space(	"blue"	,	325	,	1	,	false,	false));
        tile2	.addRow1(	new Space(	"blue"	,	326	,	1	,	false,	false));
        tile2	.addRow1(	new Space(	"blue"	,	327	,	1	,	false,	false));
        tile2	.addRow1(	new Space(	"blue"	,	328	,	1	,	false,	true));
        tile2	.addRow2(	new Space(	"blue"	,	329	,	1	,	false,	false));
        tile2	.addRow2(	new Space(	"black"	,	330	,	0	,	false,	false));
        tile2	.addRow2(	new Space(	"blue"	,	331	,	2	,	false,	false));
        tile2	.addRow2(	new Space(	"blue"	,	332	,	1	,	false,	false));
        tile2	.addRow2(	new Space(	"grey"	,	333	,	2	,	false,	true));
        tile2	.addRow3(	new Space(	"blue"	,	334	,	1	,	false,	false));
        tile2	.addRow3(	new Space(	"blue"	,	335	,	2	,	false,	false));
        tile2	.addRow3(	new Space(	"green"	,	336	,	1	,	false,	false));
        tile2	.addRow3(	new Space(	"green"	,	337	,	2	,	false,	false));
        tile2	.addRow3(	new Space(	"grey"	,	338	,	2	,	false,	false));
        tile2	.addRow3(	new Space(	"grey"	,	339	,	1	,	false,	true));
        tile2	.addRow4(	new Space(	"yellow"	,	340	,	1	,	true,	false));
        tile2	.addRow4(	new Space(	"yellow"	,	341	,	1	,	false,	false));
        tile2	.addRow4(	new Space(	"green"	,	342	,	2	,	false,	false));
        tile2	.addRow4(	new Space(	"red"	,	343	,	1	,	false,	false));
        tile2	.addRow4(	new Space(	"green"	,	344	,	1	,	false,	false));
        tile2	.addRow4(	new Space(	"grey"	,	345	,	2	,	false,	false));
        tile2	.addRow4(	new Space(	"grey"	,	346	,	1	,	false,	true));
        tile2	.addRow5(	new Space(	"yellow"	,	347	,	1	,	true,	false));
        tile2	.addRow5(	new Space(	"yellow"	,	348	,	2	,	false,	false));
        tile2	.addRow5(	new Space(	"green"	,	349	,	1	,	false,	false));
        tile2	.addRow5(	new Space(	"green"	,	350	,	1	,	false,	false));
        tile2	.addRow5(	new Space(	"grey"	,	351	,	2	,	false,	false));
        tile2	.addRow5(	new Space(	"grey"	,	352	,	1	,	false,	false));
        tile2	.addRow6(	new Space(	"yellow"	,	353	,	1	,	true,	false));
        tile2	.addRow6(	new Space(	"yellow"	,	354	,	2	,	false,	false));
        tile2	.addRow6(	new Space(	"yellow"	,	355	,	2	,	false,	false));
        tile2	.addRow6(	new Space(	"black"	,	356	,	0	,	false,	false));
        tile2	.addRow6(	new Space(	"grey"	,	357	,	1	,	false,	false));
        tile2	.addRow7(	new Space(	"yellow"	,	358	,	1	,	true,	false));
        tile2	.addRow7(	new Space(	"yellow"	,	359	,	1	,	false,	false));
        tile2	.addRow7(	new Space(	"yellow"	,	360	,	1	,	false,	false));
        tile2	.addRow7(	new Space(	"grey"	,	361	,	2	,	false,	false));
        ...
        tile2.getRow2().get(6).getNeighbours()[0] = tile3.getRow1().get(1).getId();
        tile2.getRow2().get(6).getNeighbours()[1] = tile3.getRow1().get(0).getId();

        tile3.getRow1().get(4).getNeighbours()[5] = tile2.getRow1().get(3).getId();
        tile3.getRow1().get(3).getNeighbours()[0] = tile3.getRow1().get(3).getId();
        tile3.getRow1().get(3).getNeighbours()[5] = tile3.getRow2().get(4).getId();
        tile3.getRow1().get(2).getNeighbours()[0] = tile3.getRow2().get(4).getId();
        tile3.getRow1().get(2).getNeighbours()[5] = tile3.getRow3().get(5).getId();
        tile3.getRow1().get(1).getNeighbours()[0] = tile3.getRow3().get(5).getId();
        tile3.getRow1().get(1).getNeighbours()[5] = tile3.getRow4().get(6).getId();
        tile3.getRow1().get(0).getNeighbours()[0] = tile3.getRow4().get(6).getId();
