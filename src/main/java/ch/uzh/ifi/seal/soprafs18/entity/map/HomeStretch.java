...
public class HomeStretch extends Map {
    ...
    private void setup(){
        ...
        tile2	.addRow4(	new Space(	"yellow"	,	349	,	1	,	true));
        ...
        tile2	.addRow5(	new Space(	"yellow"	,	356	,	1	,	true));
        ...
        tile2	.addRow6(	new Space(	"yellow"	,	362	,	1	,	true));
        ...
        tile2	.addRow7(	new Space(	"yellow"	,	367	,	1	,	true));
        ...
        tile3	.addRow1(	new Space(	"grey"	,	551	,	1	,	true));
        tile3	.addRow1(	new Space(	"yellow"	,	552	,	1	,	true));
        tile3	.addRow1(	new Space(	"yellow"	,	553	,	1	,	true));
        tile3	.addRow1(	new Space(	"blue"	,	554	,	1	,	true));
        tile3	.addRow1(	new Space(	"green"	,	555	,	3	,	true));
        ...
        tile5	.addRow1(	new Space(	"green"	,	445	,	1	,	true));
        tile5	.addRow1(	new Space(	"green"	,	446	,	1	,	true));
        tile5	.addRow1(	new Space(	"green"	,	447	,	1	,	true));
        tile5	.addRow1(	new Space(	"red"	,	448	,	1	,	true));
        ...
        tile6	.addRow4(	new Space(	"blue"	,	90	,	1	,	true));
        ...
        tile6	.addRow5(	new Space(	"yellow"	,	97	,	1	,	true));
        ...
        tile6	.addRow6(	new Space(	"yellow"	,	103	,	1	,	true));
        ...
        tile6	.addRow7(	new Space(	"yellow"	,	108	,	1	,	true));
