...
public class WindingPaths extends Map {
    ...
    public WindingPaths(){
        ...
        tile2	.addRow2(	new Space(	"green"	,	304	,	1	,	false));
        tile2	.addRow2(	new Space(	"green"	,	305	,	1	,	false));
        tile2	.addRow3(	new Space(	"yellow"	,	306	,	1	,	false));
        tile2	.addRow3(	new Space(	"yellow"	,	307	,	2	,	false));
        tile2	.addRow3(	new Space(	"green"	,	308	,	1	,	false));
        tile2	.addRow3(	new Space(	"black"	,	309	,	0	,	false));
        tile2	.addRow3(	new Space(	"green"	,	310	,	2	,	false));
        tile2	.addRow3(	new Space(	"green"	,	311	,	1	,	false));
        tile2	.addRow4(	new Space(	"yellow"	,	312	,	1	,	false));
        tile2	.addRow4(	new Space(	"yellow"	,	313	,	2	,	false));
        tile2	.addRow4(	new Space(	"green"	,	314	,	1	,	false));
        tile2	.addRow4(	new Space(	"green"	,	315	,	2	,	false));
        tile2	.addRow4(	new Space(	"red"	,	316	,	3	,	false));
        tile2	.addRow4(	new Space(	"black"	,	317	,	0	,	false));
        tile2	.addRow4(	new Space(	"black"	,	318	,	0	,	false));
        tile2	.addRow5(	new Space(	"yellow"	,	319	,	2	,	false));
        tile2	.addRow5(	new Space(	"grey"	,	320	,	3	,	false));
        tile2	.addRow5(	new Space(	"black"	,	321	,	0	,	false));
        tile2	.addRow5(	new Space(	"black"	,	322	,	0	,	false));
        tile2	.addRow5(	new Space(	"green"	,	323	,	2	,	false));
        tile2	.addRow5(	new Space(	"green"	,	324	,	1	,	false));
        tile2	.addRow6(	new Space(	"blue"	,	325	,	2	,	false));
        tile2	.addRow6(	new Space(	"blue"	,	326	,	1	,	false));
        tile2	.addRow6(	new Space(	"blue"	,	327	,	1	,	false));
        tile2	.addRow6(	new Space(	"green"	,	328	,	1	,	false));
        tile2	.addRow6(	new Space(	"green"	,	329	,	1	,	false));
        tile2	.addRow7(	new Space(	"blue"	,	330	,	2	,	false));
        tile2	.addRow7(	new Space(	"blue"	,	331	,	2	,	false));
        tile2	.addRow7(	new Space(	"blue"	,	332	,	1	,	false));
        tile2	.addRow7(	new Space(	"green"	,	333	,	1	,	false));
        ...
        tile3	.addRow5(	new Space(	"green"	,	211	,	1	,	false));
        tile3	.addRow5(	new Space(	"green"	,	212	,	1	,	false));
        tile3	.addRow5(	new Space(	"grey"	,	213	,	1	,	false));
        tile3	.addRow6(	new Space(	"green"	,	214	,	1	,	false));
        tile3	.addRow6(	new Space(	"green"	,	215	,	3	,	false));
        tile3	.addRow6(	new Space(	"green"	,	216	,	1	,	false));
        tile3	.addRow6(	new Space(	"blue"	,	217	,	2	,	false));
        tile3	.addRow6(	new Space(	"blue"	,	218	,	2	,	false));
        tile3	.addRow7(	new Space(	"rot"	,	219	,	1	,	false));
        tile3	.addRow7(	new Space(	"green"	,	220	,	2	,	false));
        tile3	.addRow7(	new Space(	"grey"	,	221	,	1	,	false));
        tile3	.addRow7(	new Space(	"rot"	,	222	,	2	,	false));
        ...
        tile5	.addRow1(	new Space(	"green"	,	75	,	1	,	false));
        tile5	.addRow1(	new Space(	"green"	,	76	,	1	,	false));
        tile5	.addRow1(	new Space(	"grey"	,	77	,	1	,	false));
        tile5	.addRow1(	new Space(	"grey"	,	78	,	1	,	false));
        tile5	.addRow2(	new Space(	"green"	,	79	,	1	,	false));
        tile5	.addRow2(	new Space(	"yellow"	,	80	,	1	,	false));
        tile5	.addRow2(	new Space(	"grey"	,	81	,	1	,	false));
        tile5	.addRow2(	new Space(	"blue"	,	82	,	1	,	false));
        tile5	.addRow2(	new Space(	"blue"	,	83	,	1	,	false));
        tile5	.addRow3(	new Space(	"blue"	,	84	,	1	,	false));
        tile5	.addRow3(	new Space(	"blue"	,	85	,	1	,	false));
        tile5	.addRow3(	new Space(	"yellow"	,	86	,	1	,	false));
        tile5	.addRow3(	new Space(	"yellow"	,	87	,	1	,	false));
        tile5	.addRow3(	new Space(	"grey"	,	88	,	1	,	false));
        tile5	.addRow3(	new Space(	"blue"	,	89	,	1	,	false));
        tile5	.addRow4(	new Space(	"blue"	,	90	,	1	,	false));
        tile5	.addRow4(	new Space(	"yellow"	,	91	,	1	,	false));
        tile5	.addRow4(	new Space(	"yellow"	,	92	,	1	,	false));
        tile5	.addRow4(	new Space(	"yellow"	,	93	,	0	,	false));
        tile5	.addRow4(	new Space(	"blue"	,	94	,	1	,	false));
        tile5	.addRow4(	new Space(	"grey"	,	95	,	1	,	false));
        tile5	.addRow4(	new Space(	"grey"	,	96	,	1	,	false));
        tile5	.addRow5(	new Space(	"yellow"	,	97	,	1	,	false));
        tile5	.addRow5(	new Space(	"grey"	,	98	,	1	,	false));
        tile5	.addRow5(	new Space(	"blue"	,	99	,	1	,	false));
        tile5	.addRow5(	new Space(	"blue"	,	100	,	1	,	false));
        tile5	.addRow5(	new Space(	"yellow"	,	101	,	1	,	false));
        tile5	.addRow5(	new Space(	"yellow"	,	102	,	1	,	false));
        tile5	.addRow6(	new Space(	"yellow"	,	103	,	1	,	false));
        tile5	.addRow6(	new Space(	"grey"	,	104	,	1	,	false));
